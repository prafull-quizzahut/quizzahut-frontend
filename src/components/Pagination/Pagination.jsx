...
const Pagination = () => {
  ...
  return (
    <div className="w-10/12 flex justify-between ">
      <button
      className="px-2 py-1 border-2 border-black w-20 rounded-md disabled:cursor-not-allowed"
      ...
      <button
      className="px-2 py-1 border-2 border-black bg-black text-white w-20 rounded-md disabled:cursor-not-allowed"
