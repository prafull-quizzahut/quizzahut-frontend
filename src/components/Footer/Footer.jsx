...
const Footer = () => {
  return (
    <footer className="w-full bg-sky-50 rounded-t-xl">
      <ContentWrapper>
        ...
        <div className="mx-auto w-full max-w-screen-xl">
          <div className=" grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              ...
              <ul className="text-slate-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
          ...
          <div className="px-4 py-6 bg-blue-100  md:flex md:items-center md:justify-between">
            <span className="text-sm text-slate-500  sm:text-center">
              © 2023 <Link to="/">Quizzahut™</Link>. All Rights Reserved.
            </span>
            <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              <Link to="/" className="text-slate-500 hover:text-gray-900 ">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
